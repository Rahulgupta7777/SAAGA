...
const Hero = () => {
    return (
        <header className="flex flex-col md:flex-row justify-between flex-1 w-full">
            <div className="flex-1 flex flex-col justify-center text-center items-center pt-10 md:pt-0">
                ...
                <p className="text-base md:text-lg text-brown-900 mb-8 md:mb-16 tracking-[2px]" style={{ fontFamily: "'Louis George Cafe', sans-serif" }}>
                    Transforming Beauty, Transforming You
                </p>
                <button className="bg-beige-200 text-brown-900 px-8 py-3 md:px-10 md:py-4 rounded-full text-base md:text-lg font-medium shadow-sm transition-transform duration-200 hover:-translate-y-0.5 hover:bg-beige-300 cursor-pointer w-fit z-10">
                    Explore Products
                </button>
            </div>
