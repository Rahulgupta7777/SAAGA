...
const OffersManager = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setFormData({ title: '', description: '', code: '', type: 'percentage', value: '', isActive: true });
            fetchOffers();
        } catch (error) {
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  ...
                  <p className="mt-1 font-mono text-sm text-gray-500 bg-gray-100 inline-block px-2 py-1 rounded">
                    {offer.code}
                  </p>
                  <div className="mt-4">
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md rounded-xl bg-white p-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <textarea
                  placeholder="Description (e.g. Get 50% off on all hair spa treatments)"
                  className="w-full rounded-lg border p-2"
                  rows="2"
                ...
                <button
                  type="submit"
                  className="w-full rounded-lg bg-black py-2 text-white font-bold"
                >
                  Create Offer
                </button>
              </form>
